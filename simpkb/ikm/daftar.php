...
  </div>
	...
	<label style="font-size:95%" for="nTelepon">Nomor Telepon atau Email (<b>08560001234 atau info@gmail.com</b>) : (*)</label>
...
case "2":
 ...
 $ntxt="$nVer - Nomor Verifikasi Pendaftaran Pengujian Kendaraan Bermotor Kota Malang";
 //$tlp=$tlp; //substr($tlp,1);
...
  </div>
	...
	function setBukuUji(sts) {
		...
		if(sts==1){
			...
			document.getElementById("nBiayaBuku").innerHTML = ": Rp. 25000";
			document.getElementById("nBiayaDendaBuku").innerHTML = ": Rp. 0";
		}else if(sts==3){
			document.getElementById("nBiayaBuku").innerHTML = ": Rp. 25000";
			document.getElementById("nBiayaDendaBuku").innerHTML = ": Rp. 50000";
		}else{
			document.getElementById("nBiayaBuku").innerHTML = ": Rp. 25000";
			document.getElementById("nBiayaDendaBuku").innerHTML = ": Rp. 50000";
		}
...
        <label for="radio2" style="margin-top:-20px;font-size:80%">Daftar Baru</label>
...
  </div>
	<div class="ui-body ui-body-a" >
	 ...
	 <form id="frmDaftarOK" method="post" action="daftar.php">
		...
		<tr><td>Biaya Uji</td><td class='isian-nilai'>: Rp. $Tarif</td></tr>
		<tr><td>Biaya Kartu Uji</td><td class='isian-nilai' >: Rp. $BiayaBuku</td></tr>
		<tr><td>Denda Kartu Uji</td><td class='isian-nilai'>: Rp. $DendaBuku</td></tr>
		<tr><td>Denda Terlambat Uji</td><td class='isian-nilai'>: Rp. $Denda</td></tr>

		</table>
		<hr>
			<center><h3><p style='margin-bottom:-12px'>Total Bayar<br><span style='color:red'><b>Rp. $TotalBayar</b></span></p>
		  ...
		  <a href="http://ujikirkotamalang.ip-dynamic.com/simpkb/daftar/" data-icon="back" data-theme="a" data-form="ui-btn-up-a" class=" ui-btn ui-btn-a ui-icon-back ui-btn-icon-right ui-shadow ui-corner-all">Batalkan</a>
		</form>
	</div>
<?php
...
if($_SESSION['staDaftar']==1){
	...
	//$IdWajibUji
	$IdTipeUji=0;
	$BiayaRetribusi=$_POST["BiayaRetribusi"];
	$BiayaDenda=$_POST["BiayaDenda"]+$_POST["BiayaDendaBuku"];
	$BiayaBuku=$_POST["BiayaBuku"];
	$BiayaPlat=0;
	$BiayaStiker=0;
	$BiayaTambahan=0;
	$IdJenisBayar=2;
...
  </div>
	<div class="ui-body ui-body-a" >
		...
		<?php
		  ...
		  <hr>
		  <p style='margin-bottom:-12px'>Tanggal Pengujian:<br><span style='color:red'><b>- $TglUji</b></span></p>
		  <p style='margin-bottom:-12px'>Total Bayar:<br><span style='color:red'><b>- Rp. $TotalBayar</b></span></p>
		  <p style='margin-bottom:-12px'>Nomor Virtual Account:<br><span style='color:red'><b>- 10029 $NoNewReg</b></span></p>
		  
		  <p style='margin-bottom:-12px'><img src='master.jpg' width=80%></p>
		  ";
		...
		<hr>
		<a href="javascript:submitCekBayar()" data-icon="tag" data-theme="a" data-form="ui-btn-up-a" class=" ui-btn ui-btn-a ui-icon-tag ui-btn-icon-right ui-shadow ui-corner-all">Cek Status Pembayaran</a>
	</div>
<?php
...
  </div>
	<div class="ui-body ui-body-a" >
		...
		<?php
		  ...
		  <br>
		  <p style='margin-top:10px;margin-bottom:0px;font-size:140%'><span style='background-color:green;color:white;padding:2px'>BELUM BAYAR</span></p>
		  ...
		  <p style='margin-bottom:-12px'>Tanggal Pengujian:<br><span style='color:red'><b>- $TglUji</b></span></p>
		  <p style='margin-bottom:-12px'>Total Bayar:<br><span style='color:red'><b>- Rp. $TotalBayar</b></span></p>
		  <p style='margin-bottom:-12px'>Rekening :<br><span style='color:red'><b>- 10029 2$setBrivaNo</b></span></p>
		  <p style='margin-bottom:-12px'><img src='master.jpg' width=80%></p>
		  ";
		  ?>
		  <br>
...
<a href="http://ujikirkotamalang.ip-dynamic.com/simpkb/daftar/" data-transition="flip" class="ui-icon-back ui-btn-icon-left ui-btn ui-corner-all ui-shadow ui-btn-inline ">Kembali</a>

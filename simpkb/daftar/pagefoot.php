...
            <li style="height:22px" ><a href="#panel-fixed-page2">Hasil Pengujian</a></li> -->
			...
			<li style="height:42px"><a href="http://ujikirkotamalang.ip-dynamic.com/simpkb">Halaman Depan</a> </li>
			<li style="height:42px"><a href="datakendaraan.php">Data Kendaraan</a> </li>
			<li style="height:42px"><a href="">Hasil Pengujian</a> </li>
			<li style="height:42px"><a href="">Riwayat Pengujian</a> </li>
			<li style="height:42px"><a href="">Rekap Pengujian </a> </li>			

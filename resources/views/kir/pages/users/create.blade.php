...
@section("css")
<!-- Datetime picker -->
<link rel="stylesheet" href="{{URL::to('/')}}/assets/css/kir/assets/plugins/datetimepicker/jquery.datetimepicker.css">
@endsection
...
<div class="row">
    <div class="col-xl-12">
        <div class="card m-b-30">
            <div class="card-body">
                <form action="{{route('kir.users.store')}}" method="post" autocomplete="off" onsubmit="confirm('Apakah anda yakin ingin mengirim data ini?')" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-lg-12">

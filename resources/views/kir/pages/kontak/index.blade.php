                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex mb-1">
                                                <a href="{{route('kir.kontak.show',$row->id)}}" class="btn btn-success btn-sm mr-1"><i class="fa fa-address-card"></i> Detail</a>
...
@include("kir.pages.kontak.modal.index")
    ...
    $(function(){
        ...
        $(document).on("click",".btn-delete",function(){
            ...
            if(confirm("Apakah anda yakin ingin menghapus data ini ?")){
                $("#frmDelete").attr("action", "{{ route('kir.kontak.destroy', '_id_') }}".replace("_id_", id));

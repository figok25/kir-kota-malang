        ...
        <div class="col-xl-12">
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <a href="{{ route('kir.informasi.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="mb-1 d-flex justify-content-center">
                                                    ...
                                                    @endif
                                                        <a href="{{ route('kir.informasi.edit',$row->id) }}" class="btn btn-primary btn-sm mr-1"><i class="fa fa-edit"></i> Edit</a>
    ...
    $(function(){
        ...
        $(document).on("click",".btn-delete",function(){
            ...
            if(confirm("Apakah anda yakin ingin menghapus data ini ?")){
                $("#frmDelete").attr("action", "{{ route('kir.informasi.destroy', '_id_') }}".replace("_id_", id));

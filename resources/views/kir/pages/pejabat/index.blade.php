...
@section('content')
        ...
        <div class="col-xl-12">
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <a href="{{ route('kir.pejabat.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
                                Tambah</a>
                            <a href="#" class="btn btn-success btn-filter"><i class="fa fa-filter"></i> Fiter</a>
                            <a href="{{ route('kir.pejabat.index') }}" class="btn btn-warning"><i
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex mb-1">
                                                        <a href="{{ route('kir.pejabat.show', $row->id) }}"
                                                            class="btn btn-success btn-sm mr-1"><i
                                                                class="fa fa-address-card"></i> Detail</a>
                                                        <a href="{{ route('kir.pejabat.edit', $row->id) }}"
    ...
    @include('kir.pages.pejabat.modal.index')
        ...
        $(function() {
            ...
            $(document).on("click", ".btn-delete", function() {
                ...
                if (confirm("Apakah anda yakin ingin menghapus data ini ?")) {
                    $("#frmDelete").attr("action", "{{ route('kir.pejabat.destroy', '_id_') }}".replace(
                        "_id_", id));

    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card m-b-30">
                <div class="card-body">
                    <form action="{{route('kir.menu.update',$result->id)}}" method="post" autocomplete="off" onsubmit="confirm('Apakah anda yakin ingin mengirim data ini?')" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                        <div class="row mb-3">
                            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <a href="{{route('kir.menu.index')}}" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Kembali</a>

            ...
            <div class="col-xl-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <div class="mt-5">
                            <a href="{{ route('kir.berita.index') }}" class="btn btn-warning btn-sm"><i
                                    class="fa fa-arrow-left"></i> Kembali</a>
                            <a href="{{ route('kir.berita.edit', $result->id) }}" class="btn btn-primary btn-sm"><i
            ...
            $(function() {
                ...
                $(document).on("click", ".btn-delete", function() {
                    if (confirm("Apakah anda yakin ingin menghapus data ini ?")) {
                        $("#frmDelete").attr("action", "{{ route('kir.berita.destroy', '_id_') }}"

...
@section("content")
        ...
        <div class="col-xl-12">
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <a href="{{ route('kir.galeri.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                            <a href="#" class="btn btn-success btn-filter"><i class="fa fa-filter"></i> Fiter</a>
                            <a href="{{route('kir.galeri.index')}}" class="btn btn-warning"><i class="fa fa-refresh"></i> Refresh</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex mb-1">
                                                    <a href="{{route('kir.galeri.show',$row->id)}}" class="btn btn-success btn-sm mr-1"><i class="fa fa-address-card"></i> Detail</a>
                                                    <a href="{{ route('kir.galeri.edit',$row->id) }}" class="btn btn-primary btn-sm mr-1"><i class="fa fa-edit"></i> Edit</a>
    ...
    @include("kir.pages.galeri.modal.index")
        ...
        $(function(){
            ...
            $(document).on("click",".btn-delete",function(){
                ...
                if(confirm("Apakah anda yakin ingin menghapus data ini ?")){
                    $("#frmDelete").attr("action", "{{ route('kir.galeri.destroy', '_id_') }}".replace("_id_", id));
